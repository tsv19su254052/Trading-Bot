...
class BaseAPI(abc.ABC):
    ...
    def check_column_names(self) -> bool:
        ...
        """
        if self.df is None:
            raise ValueError("To check column names, the df attribute must not be equals to None")
    ...
    def rename_column_name(self, columns: dict) -> None:
        ...
        """
        if self.df is None:
            raise ValueError("To rename columns, the df attribute must not be equals to None")
